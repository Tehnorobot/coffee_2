...
from PyQt5.QtWidgets import QTableWidgetItem, QApplication, QLineEdit, QWidget, QPushButton
from PyQt5.QtWidgets import QLabel

Form, Window = uic.loadUiType("addEditCoffeeForm.ui")
...
class Ui(QtWidgets.QDialog, Form):
    def __init__(self):
        ...
        self.setWindowTitle('git Капучино')
